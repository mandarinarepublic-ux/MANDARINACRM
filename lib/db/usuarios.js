...
export async function createUsuario({ nombre, codigo, email, username, password, rol, areas, tiendas, accesos }) {
  const id = uuid();
  ...
  // pantalla de Usuarios. Solo existe en Supabase.
  const accesosArr = Array.isArray(accesos) ? accesos : [];
