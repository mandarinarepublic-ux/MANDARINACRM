 ...
 * ⚠️ YA NO ES UNA CREDENCIAL: la identidad sale de la cookie firmada. Se
 * conserva el nombre porque alguna pantalla todavía la manda, pero el servidor
 * no la mira para decidir permisos.
 */
export const HEADER_USUARIO = 'x-mp-usuario-id'

/** Quién es el que llama, según la cookie firmada. null si no hay sesión. */
 ...
 * pasan el middleware pero NO son admin: no tienen persona detrás.
 *
