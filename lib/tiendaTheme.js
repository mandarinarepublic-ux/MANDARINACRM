...
export const tiendaTheme = {
  mandarina: {
    ...
    emoji: '🍊',
    // ☠️ Decia www.mandarinarepublic.com, que NO existe. Sale impreso dos veces
    // en el documento que recibe el cliente, asi que cada cotizacion enviada
    // mandaba a la gente a una direccion muerta. El dominio real es el que usa
    // la tienda de Shopify.
    web: 'www.mandarinaec.com',
  ...
  indstore: {
    ...
    emoji: '🏪',
    // Decia www.indstore.ec. El resto del CRM (el cupon de la hoja de pedido y
    // el panel de productos) ya usaba indlovers.com, que es el dominio real de
    // la tienda: la cotizacion era el unico sitio que decia otra cosa.
    web: 'www.indlovers.com',
    telefono: '+593 99 000 0000',
  },
}
